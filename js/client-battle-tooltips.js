var BattleTooltips = (function () {
	...
	BattleTooltips.prototype.getTemplateMinSpeed = function (template, level) {
		...
		var nature = (this.battle.tier.match(/^(\[Gen [3-7]\] )?Random Battle$/) || this.battle.gen < 3) ? 1 : 0.9;
	...
	BattleTooltips.prototype.getTemplateMaxSpeed = function (template, level) {
		...
		var value = iv + (this.battle.tier.match(/^(\[Gen [3-7]\] )?Random Battle$/) ? 21 : 63);
		var nature = (this.battle.tier.match(/^(\[Gen [3-7]\] )?Random Battle$/) || this.battle.gen < 3) ? 1 : 1.1;
