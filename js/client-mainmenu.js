(function($) {
	...
	var CreditsPopup = this.CreditsPopup = Popup.extend({
		...
		initialize: function() {
			...
			buf += '<ul><li><p><strong>Mathieu Dias-Martins</strong> [Marty-D] <small>&ndash; Research (game mechanics), Development</small></p></li>';
			buf += '<li><p><strong>Cathy J. Fitzpatrick</strong> [cathyjf] <small>&ndash; Development</small></p></li></ul>';
