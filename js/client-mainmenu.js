(function($) {
	...
	var CreditsPopup = this.CreditsPopup = Popup.extend({
		...
		initialize: function() {
			...
			buf += '<li><p><strong>Kyle Dove</strong> [Kyle_Dove] <small>&ndash; Art (battle backdrops)</small></p></li>';
			...
			buf += '<li><p><strong>Samuel Teo</strong> [Yilx] <small>&ndash; Art (main background)</small></p></li></ul>';
			buf += '<li><p><strong>Vivian Zou</strong> [Vtas] <small>&ndash; Art (alternate main background)</small></p></li></ul>';
			buf += '<h2>More</h2>';
