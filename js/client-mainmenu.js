(function ($) {
	...
	this.MainMenuRoom = this.Room.extend({
		...
		parseChatMessage: function (message, name, timestamp, isHighlighted, $chatElem) {
			...
			var clickableName = '<small>' + BattleLog.escapeHTML(group) + '</small><span class="username" data-roomgroup="' + group + '" data-name="' + BattleLog.escapeHTML(name) + '">' + BattleLog.escapeHTML(name) + '</span>';
