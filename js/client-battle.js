                ...
                case 'switch':
                    if (!this.choice) {
                        ...
                        if (this.request.forceSwitch !== true) {
                            ...
                            var freedomDegrees = faintedLength - _.filter(switchables.slice(this.battle.mySide.active.length), function(mon) { return !mon.fainted && mon.side === this.battle.mySide; }).length;
