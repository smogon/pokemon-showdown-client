		...
		update: function () {
			if (!this.curFormat) {
				...
				for (var i in BattleFormats) {
					...
					ladderButtons += '<li style="margin:5px"><button name="selectFormat" value="' + i + '" style="width:320px;height:30px;text-align:left;font:12pt Verdana">' + format.name + '</button></li>';
				}
