(function ($) {
	...
	this.RoomsRoom = Room.extend({
		...
		initialize: function () {
			...
			buf += '<p>We are a diverse community, including many people from<br>different backgrounds, mentalities and ages. Likely there will<br>be underage people around, or people that are uncomfortable<br>with NSFW content.</p>';
			buf += '<p style="font-weight:bold">3: Trans Rights! 🏳️&zwj;⚧️ </p>';
			buf += '<p>Stay the fuck off this server if you don\'t respect trans people. <br>Pretty simple!</p>';
