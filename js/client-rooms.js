(function ($) {
	...
	this.RoomsRoom = Room.extend({
		...
		initialize: function () {
			...
			buf += '<p style="width: 480px;font-size:10pt">Welcome to the Plan of Attack official client! We are small community of Pokemon players who enjoy modded games.</p><p style="width: 480px;font-size:10pt">Our goal for this server is to include as many different fangames as is possible, as well as custom concepts created by You! Join our discord to submit your own concepts and become a part of our awesome community.</p>';
			buf += '<div class="discordlist"><a href="https://discord.com/invite/zkaRcSSG" target="_blank" rel="noopener" class="ilink"><small style="float:right"></small><strong><i class="fa fa-comment-o"></i> Discord<br></strong><small>Our Discord.</small></a></div>'
