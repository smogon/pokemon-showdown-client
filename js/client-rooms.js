(function ($) {
	...
	this.RoomsRoom = Room.extend({
		...
		initialize: function () {
			...
			buf += '<div class="roomlist"><a href="https://discord.com/invite/zkaRcSSG" class="ilink"><small style="float:right"></small><strong><i class="fa fa-comment-o"></i> Discord<br></strong><small>Our Discord.</small></a></div>'
