(function ($) {
	...
	var RoomsRoom = this.RoomsRoom = Room.extend({
		...
		initialize: function () {
			...
			var buf = '<div class="pad"><div style="float:right;font-size:10pt;margin-top:3px"><button class="button" name="closeHide"><i class="fa fa-caret-right"></i> Hide</button> <button name="joinRoomPopup" class="button"><i class="fa fa-sign-in"></i> Join other room</button></div>';
