		...
		parseCommand: function (text) {
			...
			case 'challenge':
				...
				var challenge = function (targets) {
					self.challengeData = {userid: targets[0], format: targets[1] || '', team: targets[2] || ''};
					if (targets[3] && BattleFormats[targets[1]].isMultiBattle) self.challengeData.teammate = targets[3];
