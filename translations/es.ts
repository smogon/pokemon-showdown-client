...
export const translations: TranslationCatalog = {
	...
	"Something is interfering with our connection to the login server.": "Algo está interfiriendo con nuestra conexión al servidor de inicio de sesión.", // NEEDS QC
	"You have been logged out and disconnected.\n\nIf you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "Se ha cerrado tu sesión y se ha interrumpido la conexión.\n\nSi querías cambiar de nombre sin desconectarte, usa el botón «Cambiar nombre» o el comando /nick.", // NEEDS QC
	"You are not connected and cannot send {MESSAGE}.": "No hay conexión: no se puede enviar {MESSAGE}.", // NEEDS QC
	"It's been over a day since you first connected. Please refresh.": "Ha pasado más de un día desde tu primera conexión. Por favor, recarga la página.", // NEEDS QC
	"Sorry, we don't know what to do with that file.\n\nSupported file types:\n- images (to set your background)\n- downloaded replay files\n- team files": "Lo sentimos, no sabemos qué hacer con ese archivo.\n\nTipos de archivo compatibles:\n- imágenes (para establecer el fondo)\n- archivos de replay descargados\n- archivos de equipo", // NEEDS QC
	...
	"Forfeiting makes you lose the battle. Are you sure?": "Si te rindes, perderás el combate. ¿Quieres rendirte?", // NEEDS QC
	"Replacement player's name:": "Nombre del jugador sustituto:", // NEEDS QC
	...
	"Volume": "Volumen", // NEEDS QC
	"(muted)": "(silenciado)", // NEEDS QC
	"Default": "Predeterminado", // NEEDS QC
	// TRANSLATORS: "Built-in" backgrounds, as opposed to user-uploaded backgrounds
	"Official": "Oficiales", // NEEDS QC
	...
	"(empty box)": "(caja vacía)", // NEEDS QC
	"(empty team)": "(equipo vacío)", // NEEDS QC
	...
	"No formats matching \"{SEARCH}\" found": "No se encontraron formatos que coincidan con \"{SEARCH}\"", // NEEDS QC
	"No formats found": "No se encontraron formatos", // NEEDS QC
	...
	"Language room": "Sala en tu idioma", // NEEDS QC
	...
	"Turn number?": "¿Número de turno?", // NEEDS QC
	...
	"Search teams": "Buscar equipos", // NEEDS QC
	// TRANSLATORS: a jokey tone. feel free to take it or leave it
	"you have no teams lol": "no tienes ningún equipo jaja", // NEEDS QC
	"you have no teams matching {TEXT}": "no tienes equipos que coincidan con {TEXT}", // NEEDS QC
	"you have no teams in this folder": "no tienes equipos en esta carpeta", // NEEDS QC
	...
	"Folder name?": "¿Nombre de la carpeta?", // NEEDS QC
	"Rename ``{FOLDER}`` to?": "¿Nuevo nombre para ``{FOLDER}``?", // NEEDS QC
	"Delete ``{FOLDER}``? (doesn't delete teams)": "¿Eliminar ``{FOLDER}``? (no elimina los equipos)", // NEEDS QC
	...
	"(choose ability)": "(elegir habilidad)", // NEEDS QC
	...
	"You can also set natures by typing {PLUS} and {MINUS} in the EV box.": "También puedes establecer la naturaleza escribiendo {PLUS} y {MINUS} en la casilla de EVs.", // NEEDS QC
