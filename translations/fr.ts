...
export const translations: TranslationCatalog = {
	...
	"Something is interfering with our connection to the login server.": "Quelque chose interfère avec notre connexion au serveur de connexion.", // NEEDS QC
	"You have been logged out and disconnected.\n\nIf you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "Ta session a été fermée et la connexion interrompue.\n\nSi tu voulais changer de nom sans te déconnecter, utilise le bouton « Changer de nom » ou la commande /nick.", // NEEDS QC
	"You are not connected and cannot send {MESSAGE}.": "La connexion n'est pas établie : impossible d'envoyer {MESSAGE}.", // NEEDS QC
	"It's been over a day since you first connected. Please refresh.": "Ta première connexion date de plus d'un jour. Merci d'actualiser la page.", // NEEDS QC
	"Sorry, we don't know what to do with that file.\n\nSupported file types:\n- images (to set your background)\n- downloaded replay files\n- team files": "Désolé, on ne sait pas quoi faire de ce fichier.\n\nTypes de fichiers pris en charge :\n- images (pour définir ton arrière-plan)\n- fichiers de replay téléchargés\n- fichiers d'équipe", // NEEDS QC
	...
	" ({PARENTHETICAL})": " ({PARENTHETICAL})", // NEEDS QC
	...
	"Forfeiting makes you lose the battle. Are you sure?": "Si tu abandonnes, tu perds le combat. Continuer ?", // NEEDS QC
	"Replacement player's name:": "Nom du joueur remplaçant :", // NEEDS QC
	...
	"Volume": "Volume", // NEEDS QC
	"(muted)": "(muet)", // NEEDS QC
	"Default": "Par défaut", // NEEDS QC
	// TRANSLATORS: "Built-in" backgrounds, as opposed to user-uploaded backgrounds
	"Official": "Officiels", // NEEDS QC
	...
	"(empty box)": "(boîte vide)", // NEEDS QC
	"(empty team)": "(équipe vide)", // NEEDS QC
	...
	"No formats matching \"{SEARCH}\" found": "Aucun format ne correspond à « {SEARCH} »", // NEEDS QC
	"No formats found": "Aucun format trouvé", // NEEDS QC
	...
	"You are in:": "Tu participes à :", // NEEDS QC
	...
	"Language room": "Salon dans ta langue", // NEEDS QC
	...
	"Turn number?": "Numéro du tour ?", // NEEDS QC
	...
	"Search teams": "Rechercher une équipe", // NEEDS QC
	// TRANSLATORS: a jokey tone. feel free to take it or leave it
	"you have no teams lol": "tu n'as aucune équipe mdr", // NEEDS QC
	"you have no teams matching {TEXT}": "tu n'as aucune équipe correspondant à {TEXT}", // NEEDS QC
	"you have no teams in this folder": "tu n'as aucune équipe dans ce dossier", // NEEDS QC
	...
	"Folder name?": "Nom du dossier ?", // NEEDS QC
	"Rename ``{FOLDER}`` to?": "Nouveau nom pour ``{FOLDER}`` ?", // NEEDS QC
	"Delete ``{FOLDER}``? (doesn't delete teams)": "Supprimer ``{FOLDER}`` ? (ne supprime pas les équipes)", // NEEDS QC
	...
	"(choose ability)": "(choisir un talent)", // NEEDS QC
	...
	"You can also set natures by typing {PLUS} and {MINUS} in the EV box.": "Tu peux aussi définir la nature en tapant {PLUS} et {MINUS} dans le champ des EV.", // NEEDS QC
	...
	"Hidden Power Type": "Type de Puissance Cachée", // NEEDS QC
	"Tera Type": "Type Téracristal", // NEEDS QC
