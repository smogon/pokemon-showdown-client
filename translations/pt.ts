...
export const translations: TranslationCatalog = {
	...
	"Something is interfering with our connection to the login server.": "Algo está interferindo na nossa conexão com o servidor de login.", // NEEDS QC
	"You have been logged out and disconnected.\n\nIf you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "Sua sessão foi encerrada e a conexão foi interrompida.\n\nSe você queria mudar de nome sem se desconectar, use o botão \"Mudar nome\" ou o comando /nick.", // NEEDS QC
	"You are not connected and cannot send {MESSAGE}.": "Sem conexão: não é possível enviar {MESSAGE}.", // NEEDS QC
	"It's been over a day since you first connected. Please refresh.": "Já faz mais de um dia desde sua primeira conexão. Por favor, atualize a página.", // NEEDS QC
	"Sorry, we don't know what to do with that file.\n\nSupported file types:\n- images (to set your background)\n- downloaded replay files\n- team files": "Desculpe, não sabemos o que fazer com esse arquivo.\n\nTipos de arquivo aceitos:\n- imagens (para definir o plano de fundo)\n- arquivos de replay baixados\n- arquivos de equipe", // NEEDS QC
	...
	"Forfeiting makes you lose the battle. Are you sure?": "Desistir fará você perder a batalha. Tem certeza?", // NEEDS QC
	"Replacement player's name:": "Nome do jogador substituto:", // NEEDS QC
	...
	"(empty box)": "(caixa vazia)", // NEEDS QC
	"(empty team)": "(equipe vazia)", // NEEDS QC
	...
	"No formats matching \"{SEARCH}\" found": "Nenhum formato corresponde a \"{SEARCH}\"", // NEEDS QC
	"No formats found": "Nenhum formato encontrado", // NEEDS QC
	...
	"You are in:": "Você está em:", // NEEDS QC
	...
	"Language room": "Sala no seu idioma", // NEEDS QC
	...
	"Turn number?": "Número do turno?", // NEEDS QC
	...
	"Search teams": "Buscar equipes", // NEEDS QC
	// TRANSLATORS: a jokey tone. feel free to take it or leave it
	"you have no teams lol": "você não tem nenhuma equipe kkk", // NEEDS QC
	"you have no teams matching {TEXT}": "você não tem equipes correspondentes a {TEXT}", // NEEDS QC
	"you have no teams in this folder": "você não tem equipes nesta pasta", // NEEDS QC
	...
	"Folder name?": "Nome da pasta?", // NEEDS QC
	"Rename ``{FOLDER}`` to?": "Novo nome para ``{FOLDER}``?", // NEEDS QC
	"Delete ``{FOLDER}``? (doesn't delete teams)": "Excluir ``{FOLDER}``? (não exclui as equipes)", // NEEDS QC
	...
	"(choose ability)": "(escolher habilidade)", // NEEDS QC
	...
	"You can also set natures by typing {PLUS} and {MINUS} in the EV box.": "Você também pode definir a natureza digitando {PLUS} e {MINUS} na caixa de EVs.", // NEEDS QC
	...
	"Hidden Power Type": "Tipo de Poder Oculto", // NEEDS QC
	"Tera Type": "Tipo Tera", // NEEDS QC
