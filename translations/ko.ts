...
export const translations: TranslationCatalog = {
	...
	"Something is interfering with our connection to the login server.": "로그인 서버 연결에 문제가 있습니다.", // NEEDS QC
	"You have been logged out and disconnected.\n\nIf you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "로그아웃되어 연결이 끊어졌습니다.\n\n연결을 유지한 채 이름을 바꾸고 싶었다면 '이름 변경' 버튼이나 /nick 명령어를 사용하세요.", // NEEDS QC
	"You are not connected and cannot send {MESSAGE}.": "연결되어 있지 않아 다음 메시지를 보낼 수 없습니다: {MESSAGE}", // NEEDS QC
	"It's been over a day since you first connected. Please refresh.": "처음 접속한 지 하루가 넘었습니다. 새로고침해 주세요.", // NEEDS QC
	"Sorry, we don't know what to do with that file.\n\nSupported file types:\n- images (to set your background)\n- downloaded replay files\n- team files": "죄송하지만 이 파일은 어떻게 처리해야 할지 모르겠습니다.\n\n지원되는 파일 형식:\n- 이미지(배경 설정용)\n- 다운로드한 리플레이 파일\n- 팀 파일", // NEEDS QC
	...
	"Forfeiting makes you lose the battle. Are you sure?": "기권하면 배틀에서 패배합니다. 계속하시겠습니까?", // NEEDS QC
	"Replacement player's name:": "교체할 플레이어의 이름:", // NEEDS QC
	...
	"Official": "공식", // NEEDS QC
	"Custom": "사용자 지정", // NEEDS QC
	...
	"(empty box)": "(빈 박스)", // NEEDS QC
	"(empty team)": "(빈 팀)", // NEEDS QC
	...
	"No formats matching \"{SEARCH}\" found": "\"{SEARCH}\"에 해당하는 포맷을 찾을 수 없습니다", // NEEDS QC
	"No formats found": "포맷을 찾을 수 없습니다", // NEEDS QC
	...
	"Search teams": "팀 검색", // NEEDS QC
	// TRANSLATORS: a jokey tone. feel free to take it or leave it
	"you have no teams lol": "팀이 하나도 없네요 ㅋㅋ", // NEEDS QC
	"you have no teams matching {TEXT}": "{TEXT}에 해당하는 팀이 없습니다", // NEEDS QC
	"you have no teams in this folder": "이 폴더에는 팀이 없습니다", // NEEDS QC
	...
	"Folder name?": "폴더 이름은?", // NEEDS QC
	"Rename ``{FOLDER}`` to?": "``{FOLDER}``의 새 이름은?", // NEEDS QC
	"Delete ``{FOLDER}``? (doesn't delete teams)": "``{FOLDER}`` 폴더를 삭제할까요? (팀은 삭제되지 않습니다)", // NEEDS QC
	...
	"You can also set natures by typing {PLUS} and {MINUS} in the EV box.": "노력치 입력란에 {PLUS} 또는 {MINUS}를 입력해 성격을 정할 수도 있습니다.", // NEEDS QC
	...
	"Hidden Power Type": "잠재파워 타입", // NEEDS QC
	"Tera Type": "테라스탈타입", // NEEDS QC
