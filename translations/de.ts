...
export const translations: TranslationCatalog = {
	...
	"Something is interfering with our connection to the login server.": "Etwas stört unsere Verbindung zum Login-Server.", // NEEDS QC
	"You have been logged out and disconnected.\n\nIf you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "Du wurdest ausgeloggt und getrennt.\n\nWenn du deinen Namen ändern wolltest, ohne die Verbindung zu trennen, benutze den Button „Namen ändern“ oder den Befehl /nick.", // NEEDS QC
	"You are not connected and cannot send {MESSAGE}.": "Du bist nicht verbunden und kannst {MESSAGE} nicht senden.", // NEEDS QC
	"It's been over a day since you first connected. Please refresh.": "Deine erste Verbindung ist über einen Tag her. Bitte lade die Seite neu.", // NEEDS QC
	"Sorry, we don't know what to do with that file.\n\nSupported file types:\n- images (to set your background)\n- downloaded replay files\n- team files": "Sorry, mit dieser Datei können wir nichts anfangen.\n\nUnterstützte Dateitypen:\n- Bilder (als Hintergrund)\n- heruntergeladene Replay-Dateien\n- Team-Dateien", // NEEDS QC
	...
	"Forfeiting makes you lose the battle. Are you sure?": "Wenn du aufgibst, verlierst du den Kampf. Bist du sicher?", // NEEDS QC
	"Replacement player's name:": "Name des Ersatzspielers:", // NEEDS QC
	...
	"Volume": "Lautstärke", // NEEDS QC
	"(muted)": "(stumm)", // NEEDS QC
	"Default": "Standard", // NEEDS QC
	// TRANSLATORS: "Built-in" backgrounds, as opposed to user-uploaded backgrounds
	"Official": "Offiziell", // NEEDS QC
	...
	"(empty box)": "(leere Box)", // NEEDS QC
	"(empty team)": "(leeres Team)", // NEEDS QC
	...
	"No formats matching \"{SEARCH}\" found": "Keine zu „{SEARCH}“ passenden Formate gefunden", // NEEDS QC
	"No formats found": "Keine Formate gefunden", // NEEDS QC
	...
	"You are in:": "Du nimmst teil an:", // NEEDS QC
	...
	"Language room": "Raum für deine Sprache", // NEEDS QC
	...
	"Turn number?": "Rundennummer?", // NEEDS QC
	...
	"Search teams": "Teams durchsuchen", // NEEDS QC
	// TRANSLATORS: a jokey tone. feel free to take it or leave it
	"you have no teams lol": "du hast keine Teams lol", // NEEDS QC
	"you have no teams matching {TEXT}": "du hast keine Teams, die zu {TEXT} passen", // NEEDS QC
	"you have no teams in this folder": "du hast keine Teams in diesem Ordner", // NEEDS QC
	...
	"Folder name?": "Ordnername?", // NEEDS QC
	"Rename ``{FOLDER}`` to?": "Neuer Name für ``{FOLDER}``?", // NEEDS QC
	"Delete ``{FOLDER}``? (doesn't delete teams)": "``{FOLDER}`` löschen? (Teams werden nicht gelöscht)", // NEEDS QC
	...
	"(choose ability)": "(Fähigkeit wählen)", // NEEDS QC
	...
	"You can also set natures by typing {PLUS} and {MINUS} in the EV box.": "Du kannst Wesen auch festlegen, indem du {PLUS} und {MINUS} in das EV-Feld eingibst.", // NEEDS QC
	...
	"Hidden Power Type": "Kraftreserve-Typ", // NEEDS QC
	"Tera Type": "Tera-Typ", // NEEDS QC
