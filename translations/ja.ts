...
export const translations: TranslationCatalog = {
	...
	"Something is interfering with our connection to the login server.": "ログインサーバーへの接続が妨害されています。", // NEEDS QC
	"You have been logged out and disconnected.\n\nIf you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "ログアウトして切断されました。\n\n接続したまま名前を変更したい場合は、「名前を変更」ボタンか「/nick」コマンドを使ってください。", // NEEDS QC
	"You are not connected and cannot send {MESSAGE}.": "未接続のため、次のメッセージを送信できません：{MESSAGE}", // NEEDS QC
	"It's been over a day since you first connected. Please refresh.": "最初の接続から1日以上経っています。ページを更新してください。", // NEEDS QC
	"Sorry, we don't know what to do with that file.\n\nSupported file types:\n- images (to set your background)\n- downloaded replay files\n- team files": "すみませんが、このファイルの扱い方がわかりません。\n\n対応しているファイル形式：\n- 画像（背景に設定できます）\n- ダウンロードしたリプレイファイル\n- チームファイル", // NEEDS QC
	...
	"Forfeiting makes you lose the battle. Are you sure?": "降参するとこの対戦は負けになります。よろしいですか？", // NEEDS QC
	"Replacement player's name:": "交代するプレイヤーの名前：", // NEEDS QC
	...
	"(empty box)": "（空のボックス）", // NEEDS QC
	"(empty team)": "（空のチーム）", // NEEDS QC
	...
	"No formats matching \"{SEARCH}\" found": "「{SEARCH}」に一致するフォーマットが見つかりません", // NEEDS QC
	"No formats found": "フォーマットが見つかりません", // NEEDS QC
	...
	"Search teams": "チームを検索", // NEEDS QC
	// TRANSLATORS: a jokey tone. feel free to take it or leave it
	"you have no teams lol": "チームがないよｗ", // NEEDS QC
	"you have no teams matching {TEXT}": "{TEXT}に一致するチームはありません", // NEEDS QC
	"you have no teams in this folder": "このフォルダにチームはありません", // NEEDS QC
	...
	"Folder name?": "フォルダ名は？", // NEEDS QC
	"Rename ``{FOLDER}`` to?": "``{FOLDER}``の新しい名前は？", // NEEDS QC
	"Delete ``{FOLDER}``? (doesn't delete teams)": "``{FOLDER}``を削除しますか？（チームは削除されません）", // NEEDS QC
	...
	"You can also set natures by typing {PLUS} and {MINUS} in the EV box.": "努力値の入力欄に{PLUS}や{MINUS}を入力して性格を設定することもできます。", // NEEDS QC
	...
	"Hidden Power Type": "めざめるパワーのタイプ", // NEEDS QC
	"Tera Type": "テラスタイプ", // NEEDS QC
