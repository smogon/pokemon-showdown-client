...
export const translations: TranslationCatalog = {
	...
	"Something is interfering with our connection to the login server.": "與登入伺服器的連線受到干擾。", // NEEDS QC
	"You have been logged out and disconnected.\n\nIf you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "你已登出並中斷連線。\n\n如果你想在保持連線的同時變更名稱，請使用「變更名稱」按鈕或 /nick 指令。", // NEEDS QC
	"You are not connected and cannot send {MESSAGE}.": "尚未連線，無法傳送以下訊息：{MESSAGE}", // NEEDS QC
	"It's been over a day since you first connected. Please refresh.": "距離你首次連線已超過一天，請重新整理頁面。", // NEEDS QC
	"Sorry, we don't know what to do with that file.\n\nSupported file types:\n- images (to set your background)\n- downloaded replay files\n- team files": "抱歉，我們不知道要怎麼處理這個檔案。\n\n支援的檔案類型：\n- 圖片（用於設定背景）\n- 下載的重播檔案\n- 隊伍檔案", // NEEDS QC
	...
	"Forfeiting makes you lose the battle. Are you sure?": "認輸將會輸掉這場對戰。確定嗎？", // NEEDS QC
	"Replacement player's name:": "替換玩家的名稱：", // NEEDS QC
	...
	"(empty box)": "（空盒子）", // NEEDS QC
	"(empty team)": "（空隊伍）", // NEEDS QC
	...
	"No formats matching \"{SEARCH}\" found": "沒有符合「{SEARCH}」的對戰格式", // NEEDS QC
	"No formats found": "沒有找到對戰格式", // NEEDS QC
	...
	"Search teams": "搜尋隊伍", // NEEDS QC
	// TRANSLATORS: a jokey tone. feel free to take it or leave it
	"you have no teams lol": "你還沒有隊伍哈哈", // NEEDS QC
	"you have no teams matching {TEXT}": "沒有符合{TEXT}的隊伍", // NEEDS QC
	"you have no teams in this folder": "這個資料夾裡沒有隊伍", // NEEDS QC
	...
	"Folder name?": "資料夾名稱？", // NEEDS QC
	"Rename ``{FOLDER}`` to?": "``{FOLDER}``的新名稱？", // NEEDS QC
	"Delete ``{FOLDER}``? (doesn't delete teams)": "刪除``{FOLDER}``？（不會刪除隊伍）", // NEEDS QC
	...
	"You can also set natures by typing {PLUS} and {MINUS} in the EV box.": "你也可以在努力值輸入框中輸入{PLUS}或{MINUS}來設定性格。", // NEEDS QC
	...
	"Hidden Power Type": "覺醒力量屬性", // NEEDS QC
	"Tera Type": "太晶屬性", // NEEDS QC
