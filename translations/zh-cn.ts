...
export const translations: TranslationCatalog = {
	...
	"Something is interfering with our connection to the login server.": "与登录服务器的连接受到干扰。", // NEEDS QC
	"You have been logged out and disconnected.\n\nIf you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "你已登出并断开连接。\n\n如果你想在保持连接的同时更改名字，请使用“更改名字”按钮或 /nick 命令。", // NEEDS QC
	"You are not connected and cannot send {MESSAGE}.": "尚未连接，无法发送以下消息：{MESSAGE}", // NEEDS QC
	"It's been over a day since you first connected. Please refresh.": "距离你首次连接已超过一天，请刷新页面。", // NEEDS QC
	"Sorry, we don't know what to do with that file.\n\nSupported file types:\n- images (to set your background)\n- downloaded replay files\n- team files": "抱歉，我们不知道要怎么处理这个文件。\n\n支持的文件类型：\n- 图片（用于设置背景）\n- 下载的回放文件\n- 队伍文件", // NEEDS QC
	...
	"Forfeiting makes you lose the battle. Are you sure?": "认输将会输掉这场对战。确定吗？", // NEEDS QC
	"Replacement player's name:": "替换玩家的名字：", // NEEDS QC
	...
	"No formats matching \"{SEARCH}\" found": "没有符合“{SEARCH}”的对战格式", // NEEDS QC
	"No formats found": "没有找到对战格式", // NEEDS QC
	...
	"Search teams": "搜索队伍", // NEEDS QC
	// TRANSLATORS: a jokey tone. feel free to take it or leave it
	"you have no teams lol": "你还没有队伍哈哈", // NEEDS QC
	"you have no teams matching {TEXT}": "没有符合{TEXT}的队伍", // NEEDS QC
	"you have no teams in this folder": "这个文件夹里没有队伍", // NEEDS QC
	...
	"Folder name?": "文件夹名称？", // NEEDS QC
	"Rename ``{FOLDER}`` to?": "``{FOLDER}``的新名称？", // NEEDS QC
	"Delete ``{FOLDER}``? (doesn't delete teams)": "删除``{FOLDER}``？（不会删除队伍）", // NEEDS QC
	...
	"You can also set natures by typing {PLUS} and {MINUS} in the EV box.": "你也可以在努力值输入框中输入{PLUS}或{MINUS}来设置性格。", // NEEDS QC
	...
	"Hidden Power Type": "觉醒力量属性", // NEEDS QC
	"Tera Type": "太晶属性", // NEEDS QC
