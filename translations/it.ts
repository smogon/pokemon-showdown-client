...
export const translations: TranslationCatalog = {
	...
	"Something is interfering with our connection to the login server.": "Qualcosa interferisce con la connessione al server di accesso.", // NEEDS QC
	"You have been logged out and disconnected.\n\nIf you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "Il logout è stato effettuato e la connessione è stata chiusa.\n\nSe volevi cambiare nome senza disconnetterti, usa il pulsante «Cambia nome» o il comando /nick.", // NEEDS QC
	"You are not connected and cannot send {MESSAGE}.": "Connessione assente: impossibile inviare {MESSAGE}.", // NEEDS QC
	"It's been over a day since you first connected. Please refresh.": "È passato più di un giorno dalla tua prima connessione. Ricarica la pagina.", // NEEDS QC
	"Sorry, we don't know what to do with that file.\n\nSupported file types:\n- images (to set your background)\n- downloaded replay files\n- team files": "Spiacenti, non sappiamo cosa fare con questo file.\n\nTipi di file supportati:\n- immagini (per impostare lo sfondo)\n- file di replay scaricati\n- file di squadra", // NEEDS QC
	...
	"Forfeiting makes you lose the battle. Are you sure?": "Abbandonando perderai la lotta. Confermi?", // NEEDS QC
	"Replacement player's name:": "Nome del giocatore sostituto:", // NEEDS QC
	...
	"(muted)": "(audio disattivato)", // NEEDS QC
	"Default": "Predefinito", // NEEDS QC
	// TRANSLATORS: "Built-in" backgrounds, as opposed to user-uploaded backgrounds
	"Official": "Ufficiali", // NEEDS QC
	...
	"(empty box)": "(box vuoto)", // NEEDS QC
	"(empty team)": "(squadra vuota)", // NEEDS QC
	...
	"No formats matching \"{SEARCH}\" found": "Nessun formato corrisponde a \"{SEARCH}\"", // NEEDS QC
	"No formats found": "Nessun formato trovato", // NEEDS QC
	...
	"You are in:": "Stai partecipando a:", // NEEDS QC
	...
	"Language room": "Stanza nella tua lingua", // NEEDS QC
	...
	"Turn number?": "Numero del turno?", // NEEDS QC
	...
	"Search teams": "Cerca squadre", // NEEDS QC
	// TRANSLATORS: a jokey tone. feel free to take it or leave it
	"you have no teams lol": "non hai nessuna squadra ahah", // NEEDS QC
	"you have no teams matching {TEXT}": "non hai squadre che corrispondono a {TEXT}", // NEEDS QC
	"you have no teams in this folder": "non hai squadre in questa cartella", // NEEDS QC
	...
	"Folder name?": "Nome della cartella?", // NEEDS QC
	"Rename ``{FOLDER}`` to?": "Nuovo nome per ``{FOLDER}``?", // NEEDS QC
	"Delete ``{FOLDER}``? (doesn't delete teams)": "Eliminare ``{FOLDER}``? (le squadre non verranno eliminate)", // NEEDS QC
	...
	"(choose ability)": "(scegli un'abilità)", // NEEDS QC
	...
	"You can also set natures by typing {PLUS} and {MINUS} in the EV box.": "Puoi anche impostare la natura digitando {PLUS} e {MINUS} nella casella degli EV.", // NEEDS QC
	...
	"Hidden Power Type": "Tipo di Introforza", // NEEDS QC
	"Tera Type": "Teratipo", // NEEDS QC
