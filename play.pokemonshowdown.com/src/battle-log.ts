		...
		if (args[0] === 'faint') {
			...
			if (moveid === 'earthquake') {
				...
				const quotes = [
					...
					"0 Atk Magikarp Splash vs. Lvl 1 0 HP / 0- Def Yo Mama : 321-378 (675 - 750%) -- guaranteed OHKO",
			...
			// 	}
				...
				const dadJokes = [
					...
					"4 SpA Small Gust of Wind vs. 0 HP / 4 SpD Kartana: 960-1132 (370.6 - 437%) -- guaranteed OHKO",
					...
					"Why did the Garganacl ragequit after losing a battle? Because it was salty!",
					...
					"Why did people used to love Donphan so much? Because it had Great Tusks!",
