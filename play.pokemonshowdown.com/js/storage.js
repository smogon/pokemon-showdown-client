...
Storage.bg = {
	...
	load: function (bgUrl, bgid, hues) {
		...
		if (!hues) {
			switch (bgid) {
			case 'horizon':
				hues = ["227.058823529412,21.1618257261411%", "231.176470588235,21.25%", "234.418604651163,22.9946524064171%", "221.818181818182,30%", "222.413793103448,22.8346456692913%", "221.818181818182,35.8695652173913%", "221.111111111111,24.3243243243243%", "217.241379310345,22.8346456692913%"];
				...
				break;
			case 'ocean':
				hues = ["207.1875,54.7008547008547%", "207.36,50.6072874493927%", "207.931034482759,54.7169811320755%", "208.235294117647,61.4457831325301%", "211.818181818182,61.1111111111111%", "214.468085106383,54.0229885057471%", "205,52.9411764705882%", "187.5,42.8571428571429%"];
				...
				break;
			case 'shaymin':
				hues = ["30,23.5294117647059%", "38.8235294117647,19.5402298850575%", "66,8.1967213114754%", "75,7.79220779220779%", "60,7.86516853932585%", "120,5.08474576271187%", "152.307692307692,5.67685589519651%", "168.75,8.60215053763441%"];
				attrib = '<a href="http://cargocollective.com/bluep" target="_blank" class="subtle">"Shaymin" <small>background by Daniel Kong</small></a>';
				break;
			case 'charizards':
				hues = ["151.2,20.4918032786885%", "132.307692307692,15.2941176470588%", "160.46511627907,22.7513227513228%", "161.666666666667,21.6867469879518%", "187.5,18.4615384615385%", "202,25.4237288135593%", "206.511627906977,36.7521367521367%", "207.457627118644,53.1531531531531%"];
				...
				break;
			case 'psday':
				hues = ["285.6,21.3675213675214%", "322.5,15.6862745098039%", "294,15.8730158730159%", "264,23.489932885906%", "277.5,21.0526315789474%", "346.285714285714,13.9442231075697%", "336.585365853659,18.552036199095%", "291.428571428571,17.2131147540984%"];
