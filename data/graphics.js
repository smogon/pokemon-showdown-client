...
var BattleEffects = {
	...
	fist: { // by Pokemon Showdown user SailorCosmos
		url: 'fist.png',
		w: 55, h: 49
	},
	foot: { // by Pokemon Showdown user SailorCosmos
		url: 'foot.png',
		w: 50, h: 75
	},
	topbite: {
	...
	leftslash: { // by Pokemon Showdown user Modeling Clay
		url: 'leftslash.png',
		w: 57, h: 56
	},
	rightslash: { // by Pokemon Showdown user Modeling Clay
		url: 'rightslash.png',
		w: 57, h: 56
	},
	alpha: { // Ripped from Pokemon Global Link
		url: 'alpha.png',
		w: 80, h: 80
	},
	omega: { // Ripped from Pokemon Global Link
		url: 'omega.png',
		w: 80, h: 80
	},
	rainbow: {
...
var BattleMoveAnims = {
	...
	meteormash: {
		anim: function(battle, args) {
			...
			battle.backgroundEffect("url('fx/bg-space.jpg')", 900, 0.4);
			battle.showEffect('fist', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
