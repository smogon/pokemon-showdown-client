...
exports.BattleFormats = {
	...
	endlessbattleclause: {
		...
		banlist: ['Leppa Berry + Recycle', 'Harvest + Leppa Berry', 'Trace + Leppa Berry', 'Leppa Berry + Trick', 'Leppa Berry + Switcheroo', 'Leppa Berry + Bestow', 'Fling + Leppa Berry', 'Assist + Leppa Berry'],
		validateSet: function (set, format, setHas) {
			if (format.gameType === 'singles' && format.id !== 'anythinggoes' && 'healpulse' in setHas) {
