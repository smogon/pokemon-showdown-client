...
Endless Battleとは、その名の通り、終わりのない戦いのことです。エンドレスバトルの構成要素は、とおせんぼう、かげふみ、ありじごくなどの後退を不可能にするポケモン、いやしのはどうなどの相手を回復する技、なまける、じこさいせい、はねやすめなどの自分のポケモンを元気にする手段、PPを回復するヒメリのみ、リサイクルによるヒメリのみの継続的な生成などです。
