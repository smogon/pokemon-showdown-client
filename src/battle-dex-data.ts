...
const BattlePokemonIconIndexes: {[id: string]: number} = {
	...
	blobbostherian: 1379 + (47 * 12) + 26,
	blobbospostmodern: 1379 + (47 * 12) + 27,
	blobbosfnaf: 1379 + (47 * 12) + 28,
	blobbostrips: 1379 + (47 * 12) + 29,
	blobbosbirb: 1379 + (47 * 12) + 30,
	blobbosathlete: 1379 + (47 * 12) + 31,
	blobbosgay: 1379 + (47 * 12) + 32,
	blobbosmountain: 1379 + (47 * 12) + 33,
	blobbospika: 1379 + (47 * 12) + 34,
	blobboschef: 1379 + (47 * 12) + 35,
	blobbosmexican: 1379 + (47 * 12) + 36,
	blobbosfish: 1379 + (47 * 12) + 37,
	blobbospizza: 1379 + (47 * 12) + 38,
	blobbosnightmare: 1379 + (47 * 12) + 39,
	blobboshoenn: 1379 + (47 * 12) + 40,
	blobboskirby: 1379 + (47 * 12) + 41,
	blobbosjackolantern: 1379 + (47 * 12) + 42,
	blobboseggdog: 1379 + (47 * 12) + 43,
	blobbosmetal: 1379 + (47 * 12) + 44,
	blobbosadesign: 1379 + (47 * 12) + 45,
	blobbosexplosion: 1379 + (47 * 12) + 46,
	blobboskalos: 1379 + (47 * 12) + 47,
	blobbosmega: 1379 + (47 * 12) + 48,
	blobboselectric: 1379 + (47 * 12) + 49,
	blobbosomori: 1379 + (47 * 12) + 50,
	blobbossneed: 1379 + (47 * 12) + 51,
	blobbossus: 1379 + (47 * 12) + 52,
	blobbostandor: 1379 + (47 * 12) + 53,
